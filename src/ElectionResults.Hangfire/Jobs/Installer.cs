...
public static class Installer
{
    ...
    public static WebApplication WithJobs(this WebApplication app)
    {
        ...
        recurringJobManager.AddOrUpdate<DownloadAndProcessTurnoutResultsJob>($"europarlamentare09062024-data-processor", x => x.Run("europarlamentare09062024", 51, true, StageCode.PART), "*/5 * * * *");
